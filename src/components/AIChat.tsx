...
function CaseStudyCard({ caseStudy }: { caseStudy: Message['caseStudy'] }) {
  ...
  return (
    <div className="mt-4 mb-2 p-6 border border-orange-200 rounded-xl bg-orange-50 shadow-sm animate-fade-in w-[90%]">
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1">
          <div className="flex items-center mb-3">
            ...
            <a
              ...
              className="text-xl font-semibold text-orange-700 hover:underline"
            >
              {caseStudy.name}
            </a>
            <span className="ml-3 text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded-full">
              {caseStudy.industry}
            </span>
          </div>
        ...
        {/* Case Study Image */}
        <div className="flex-shrink-0 w-40 h-28 bg-white rounded-lg p-2 shadow-sm border border-orange-100">
          <img
